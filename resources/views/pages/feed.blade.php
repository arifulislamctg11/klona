...
<body>
    ...
    @section('content')
        ...
        <div style="display:flex;flex-direction:row; justify-content: flex-start; align-items: flex-start;" class="popup">
            <div style="position:absolute;" id="full">
                <div style="display:none;" class="searchform">
                    <form method="POST" action="{{ route('users.search') }}">
                        @csrf
                        <div style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
                            <input style="width:15rem;" class="form-control" type="text" name="query"
                                placeholder="Enter user name">
                            <button style="margin-top:0.5rem;" class="btn btn-primary" type="submit">Search</button>
                        </div>
                    </form>
                </div>
                <div class="cancelbtn" style="display:none;margin-top:-9rem;margin-left:-1.5rem;">
                    <img style="width:2rem;"
                        src="https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../releases/preview/7.2.0/png/iconmonstr-x-mark-lined.png&r=0&g=0&b=0">
                </div>
