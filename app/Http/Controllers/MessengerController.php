...
class MessengerController extends Controller
{
        ...
        SELECT *
         FROM (
            ...
            WHERE listMembers.id IS NULL
                ...
                # Filtering followed-followed by entries
    ...
    public function sendMessage(Request $request)
    {
        ...
        //file_get_contents('http://216.153.61.196:6001', false, stream_context_create(['http' => ['method' => 'POST', 'header' => 'Content-Type: application/json', 'content' => json_encode($message)]]));
        // 0423
