...
class FeedController extends Controller
{
    ...
    {
        $data = [
            'posts' => PostsHelperServiceProvider::getFeedPosts(Auth::user()->id, true),
            'suggestions' =>MembersHelperServiceProvider::getSuggestedMembers(),
        ];
        //old version return response()->json(['success' => true, 'data' =>  PostsHelperServiceProvider::getFeedPosts(Auth::user()->id, true),]);
