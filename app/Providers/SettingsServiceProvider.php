    ...
    public function boot()
    {
        ...
        if(self::hasSoketiSettings()){
            ...
            if (getSetting('websockets.soketi_host_address')) {
                ...
                config(['broadcasting.connections.soketi.options.httpHost' => getSetting('websockets.soketi_host_address')]);
                config(['broadcasting.connections.soketi.options.httpPath' => '/']);
            }
            if (getSetting('websockets.soketi_host_port')) {
                config(['broadcasting.connections.soketi.options.port' => getSetting('websockets.soketi_host_port')]); //0423
                config(['broadcasting.connections.soketi.options.httpPort' => getSetting('websockets.soketi_host_port')]);
        ...
        if(getSetting('site.allow_profile_bio_markdown_links')){
