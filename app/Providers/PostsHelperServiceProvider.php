...
class PostsHelperServiceProvider extends ServiceProvider
{
    ...
    {
        $followedPosts = self::getFilteredPosts($userID, $encodePostsToHtml, $pageNumber, $mediaType, false, false, false, $sortOrder, $searchTerm);
    //    $allPosts = self::getFilteredPosts($userID, $encodePostsToHtml, $pageNumber, $mediaType, false, false, false, $sortOrder, $searchTerm);

    //    $mergedPosts = $followedPosts->concat($allPosts);
    ...
    public static function getFilteredPosts($userID, $encodePostsToHtml, $pageNumber, $mediaType, $ownPosts, $hasSub, $bookMarksOnly, $sortOrder = false, $searchTerm = '')
    {
        ...
        // For feed page
            ...
            $posts = self::filterPosts($posts, $userID, 'allall');
        }
